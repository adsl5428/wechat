...
<head>
    ...
    <script src="../js/zepto.min.js"></script><script src="../js/picker.js"></script><script src="../js/picker-city.js"></script>
    <script>
        $(function(){
...
<div class="page-hd">
    ...
    <p class="page-hd-desc">使用picker,需加载picker.js,使用省市县还需要加载picker-city.js</p>
</div>
<form id="form">
    <div class="weui_cells weui_cells_form ">
        ...
        <div class="weui_cell">
            <div class="weui_cell_hd"><label for="" class="weui_label">单列:</label></div>
            <div class="weui_cell_bd weui_cell_primary">
